  ...
  return (
    <div>
      ...
      <div className="flex justify-center mt-4">
        <button
          className={`mr-4 p-2 ${
            range === "daily" ? "bg-blue-500 text-white" : "bg-gray-200"
          }`}
        ...
        <button
          className={`p-2 mr-4 ${
            range === "weekly" ? "bg-blue-500 text-white" : "bg-gray-200"
          }`}
        ...
        <button
          className={`p-2 mr-4 ${
            range === "monthly" ? "bg-blue-500 text-white" : "bg-gray-200"
          }`}
        ...
        <button
          className={`p-2 ${
            range === "yearly" ? "bg-blue-500 text-white" : "bg-gray-200"
          }`}
